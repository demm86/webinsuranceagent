...
class PolicyStatusComponent extends Component {
    ...
    onSubmit(values) {
        let policyStatusname = AuthenticationService.getLoggedInPolicyStatusName()
        ...
        if (this.state.id === -1) {
            PolicyStatusDataService.createTodo(policyStatusname, todo)
                .then(() => this.props.history.push('/todos'))
        } else {
            PolicyStatusDataService.updateTodo(policyStatusname, this.state.id, todo)
                .then(() => this.props.history.push('/todos'))
        }
